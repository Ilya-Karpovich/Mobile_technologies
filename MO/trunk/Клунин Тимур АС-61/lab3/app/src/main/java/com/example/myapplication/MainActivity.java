...
public class MainActivity extends Activity {
    ...
    void fillData() {
            products.add(new Product("набор обиван ", "3500",
                    R.drawable.a, false));
            products.add(new Product("набор рамэн ", "3500",
                    R.drawable.b, false));
            products.add(new Product("набор штурмовик  ", "3500",
                    R.drawable.c, false));
            products.add(new Product("набор сэндпипл ", "3500",
                    R.drawable.d, false));
            products.add(new Product("набор хачапури ", "3500",
                    R.drawable.e, false));
    }
